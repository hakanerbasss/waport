...
Token ile Excel, Python, Node.js, n8n ve her HTTP istemcisinden mesaj gönder.

🌐 **Demo:** [waport.wizaicorp.com](https://waport.wizaicorp.com)  
...
Sub WhatsAppGonder()
    ...
    ' A sütunu: telefon, B sütunu: mesaj
    Dim i As Integer
    For i = 2 To 100
        ...
        Cells(i, 3).Value = http.responseText ' Sonucu C sütununa yaz
        Application.Wait Now + TimeValue("0:00:01") ' 1sn bekle
    Next i
...
// Google Sheets'ten toplu gönder
...
# Veritabanı bozuldu
rm ~/whatsapp-api/data/database.bin
wa
